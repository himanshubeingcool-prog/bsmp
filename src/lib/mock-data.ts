...
export const RANKS: Rank[] = [
  { id: 'rank-voter', name: 'Voter', price: 0, color: '#22d3ee', description: 'Free rank for voting on server lists.', perks: ['/fly in spawn', '2x vote rewards', 'Cyan name color', 'Access to vote-only rewards'], badge: 'V', popular: false },
  { id: 'rank-vip', name: 'VIP', price: 9.99, color: '#06b6d4', description: 'Get started with premium perks.', perks: ['/fly everywhere', '/hat command', '/craft command', '/ec (enderchest)', '3x vote rewards', 'VIP chat color'], badge: 'VIP', monthlyPrice: 4.99, popular: false },
  ...
  { id: 'rank-mvpp', name: 'MVP+', price: 34.99, color: '#67e8f9', description: 'Premium experience with exclusive perks.', perks: ['All MVP perks', '/nickname', '/skull command', '/workbench', '/anvil', '5x vote rewards', 'Custom join message', 'Exclusive MVP+ prefix', 'Animated name tag'], badge: 'MVP+', monthlyPrice: 14.99, popular: false },
  { id: 'rank-elite', name: 'Elite', price: 59.99, color: '#eab308', description: 'Elite treatment with maximum perks.', perks: ['All MVP+ perks', '/gamemode spectator', '/teleport command', '/weather command', '/time command', '6x vote rewards', 'Elite chat prefix [ELITE]', 'Colored name in tab', 'Nickname colors', 'Priority queue access'], badge: 'E', monthlyPrice: 24.99, popular: false },
  { id: 'rank-immortal', name: 'Immortal', price: 99.99, color: '#facc15', description: 'Immortal status with god-like powers.', perks: ['All Elite perks', '/gamemode creative (limited)', '/god command', '/top command', '/jump command', '7x vote rewards', 'Immortal chat prefix [IMMORTAL]', 'Firework join effect', 'Custom tag colors', 'Beta feature access', 'Exclusive Discord role'], badge: 'I', monthlyPrice: 39.99, popular: true },
  { id: 'rank-legend', name: 'Legend', price: 199.99, color: '#fde047', description: 'The ultimate rank. Become a legend.', perks: ['All Immortal perks', 'Lifetime rank (no expiry)', '/fly in all worlds', '10x vote rewards', 'Legend chat prefix [LEGEND]', 'Custom particle trail', 'Custom name tag glow', 'Access to all future perks', 'Dedicated Discord category', 'Priority support', 'Weekly reward crates', 'Personalized server item'], badge: 'L', popular: false },
];
