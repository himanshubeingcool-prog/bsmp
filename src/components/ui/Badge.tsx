...
export function Badge({ variant = 'default', size = 'sm', children, className = '' }: BadgeProps) {
  const variants: Record<string, string> = {
    ...
    success: 'bg-cyan-900/40 text-cyan-400 border-cyan-500/30',
    ...
    premium: 'bg-gradient-to-r from-cyan-900/40 to-gold-900/40 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-gold-400 border-cyan-500/20',
  };
